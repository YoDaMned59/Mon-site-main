        ...
        >
          ...
          <div className="about__grid">
            <div className="about__text">
              <p>
                Passionné par le développement web depuis plus de 1 an, je crée des solutions numériques qui allient performance, esthétique et facilité d'utilisation. Grâce à mes compétences, je mets en place des sites web intuitifs,
              ...
              <p>
                ...
                en toute sécurité et avec des mises à jour régulières pour maintenir votre compétitivité.</p>
            </div>
